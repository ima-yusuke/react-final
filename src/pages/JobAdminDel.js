...
function JobAdminDel(){
    ...
    const revivejob=(e)=>{
        jsonSrv.send('reviveJob.php',e.target.value)
        .then(res=>{
            console.log(res); 
        })
        .catch(err=>{
        ...
        {jobs.map((val,id)=>
            ...
            <div className="card" key={id}>
                ...
                <div className="card-body">
                    ...
                    <button name="jobid" value={val['jobid']} onClick={revivejob}>revival</button>
                </div>
            </div>:null
        )}
    </section>
